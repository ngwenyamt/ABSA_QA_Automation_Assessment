...
/**
 * This reusable class MainClass_Junit is used to handle the Unit Testing(Junit) consumption
 */
public class MainClass_Junit {
    public static WebDriver wdriver;
    protected Enablers enablers;
    protected static Logger log = LogManager.getLogger();

    // Default constructor
    public MainClass_Junit() {
    }

    // Constructor to initialize WebDriver and PageFactory
    public MainClass_Junit(WebDriver wdriver) {
        this.wdriver = wdriver;
        PageFactory.initElements(wdriver, this);
        enablers = new Enablers(wdriver);
    }
    ...
    public WebDriver setupWebDriver(String browserName) throws MalformedURLException {
        ...
        Boolean isHeadless = Boolean.valueOf(this.getConfigPropertyValue("src/test/java/resources/execution.properties", "IsHeadless"));
